...
# inspired of https://github.com/docker/docker/blob/master/pkg/namesgenerator/names-generator.go  # NOQA
...
right = [
    # Muhammad ibn Jābir al-Ḥarrānī al-Battānī was a founding
    # father of astronomy.
    # https://en.wikipedia.org/wiki/Mu%E1%B8%A5ammad_ibn_J%C4%81bir_al-%E1%B8%A4arr%C4%81n%C4%AB_al-Batt%C4%81n%C4%AB  # NOQA
    "albattani",
    ...
    # June Almeida - Scottish virologist who took the first
    # pictures of the rubella virus
    # https://en.wikipedia.org/wiki/June_Almeida
    "almeida",

    # Maria Gaetana Agnesi - Italian mathematician, philosopher, theologian and
    # humanitarian. She was the first woman to write a mathematics handbook and
    # the first woman appointed as a Mathematics Professor at a University.
    ...
    # Hugh Beaver, British engineer, founder of
    ...
    # Elizabeth Blackwell - American doctor and first American woman
    ...
    # to receive a Ph.D. in mathematics; she earned it
    ...
    # who pioneered techniques that remained top secret for decades.
    # Also an accomplished numismatist
    # https://en.wikipedia.org/wiki/Joan_Clarke
    "clarke",

    # Jane Colden - American botanist widely considered the first
    # female American botanist
    ...
    # to be awarded the Nobel Prize in Physiology or Medicine.
    ...
    # architect who designed a series of computers that were the fastest
    # in the world for decades.
    # https://en.wikipedia.org/wiki/Seymour_Cray
    "cray",

    # This entry reflects a husband and wife team who worked together:
    # Joan Curran was a Welsh scientist who developed radar and invented chaff,
    ...
    # and mathematical scientist.
    # https://en.wikipedia.org/wiki/Edsger_W._Dijkstra
    "dijkstra",

    # Donna Dubinsky - played an integral role in the development of personal
    # digital assistants (PDAs) serving as CEO of Palm, Inc.
    # and co-founding Handspring.
    ...
    # Richard Feynman was a key contributor to quantum mechanics
    ...
    # of the electroanalytical method, and recipient of the Nobel Prize
    ...
    # of protein crystallography. She was awarded the Nobel Prize
    ...
    # Hypatia - Greek Alexandrine Neoplatonist philosopher in Egypt who was one
    # of the earliest mothers of mathematics
    ...
    # Jack Kilby invented silicone integrated circuits and
    ...
    # Donald Knuth - American computer scientist, author of
    # "The Art of Computer Programming" and creator of
    ...
    # for his seminal work in distributed systems and was the winner
    ...
    # the relation between the luminosity and the period of
    ...
    # Mahavira - Ancient Indian mathematician during 9th century AD
    # who discovered basic algebraic identities
    ...
    # system based on European telegraphs and was
    # a co-developer of the Morse code
    ...
    # first female member of the Royal Statistical Society and a pioneer
    ...
    # Robert Noyce invented silicone integrated circuits and gave
    ...
    # 1925, proposed in her Ph.D. thesis an explanation for the composition of
    # stars in terms of the relative abundances of hydrogen and helium.
    # https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin
    "payne",

    # Radia Perlman is a software designer and network engineer and most famous
    # for her invention of the spanning-tree protocol (STP).
    ...
    # Henri Poincaré made fundamental contributions in
    ...
    # information by reporting disclosures by whistleblowers such as
    # Edward Snowden.
    ...
    # C. V. Raman - Indian physicist who won the Nobel Prize in 1930
    # for proposing the Raman effect.
    ...
    # Rita Levi-Montalcini - Won Nobel Prize in Physiology or Medicine jointly
    # with colleague Stanley Cohen for the discovery of nerve growth factor
    ...
    # the Saha equation, used to describe chemical and
    # physical conditions in stars
    # https://en.wikipedia.org/wiki/Meghnad_Saha
    "saha",

    # Jean E. Sammet developed FORMAC, the first widely used computer language
    # for symbolic manipulation of mathematical formulas.
    ...
    # Programming Freedom. He also invented the concept of copyleft to protect
    # the ideals of this movement, and enshrined this concept in
    ...
    # the Bharat Ratna, in 1955. On his birthday, 15 September is celebrated
    ...
    # Physiology or Medicine in 1995 for research on the genetic
...
def GetRandomName(retry=None):
    ...
    while name == "boring_wozniak":
        l_idx = random.randint(0, len(left) - 1)
        r_idx = random.randint(0, len(right) - 1)
        name = "%s_%s" % (left[l_idx], right[r_idx])
